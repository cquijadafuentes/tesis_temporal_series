...
void informacion_datos(TempRasterQuadComp& nqc, string fn){
...
void informacion_estructura(TempRasterQuadComp& nqc){
...
void getAccess(TempRasterQuadComp& nqc){
...
void getTimeSerie(TempRasterQuadComp& nqc){
